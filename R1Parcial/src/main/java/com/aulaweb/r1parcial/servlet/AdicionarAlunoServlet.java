...
//Servlet que lida com request do caminho "/adicionarAluno"
@WebServlet(name = "AdicionarAlunoServletServlet", urlPatterns = {"/adicionarAluno"})
public class AdicionarAlunoServlet extends HttpServlet {
    
    //Metodo que lida com request do tipo post para adicionar um nova aluno
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!erro){
            //Instancia o objeto Aluno com todos os atributos menos o id
            Aluno aluno = new Aluno(nome, email, curso, anoDeIngresso);
            //Instancia o AlunoService para poder salvar
        ...
        //Caso houver erros
            ...
            //Reenvi os dados caso ocorra um erro para não precisar digitar novamente
            ...
            request.getRequestDispatcher("/adicionarAluno.jsp").forward(request, response);
        }
    }
}
